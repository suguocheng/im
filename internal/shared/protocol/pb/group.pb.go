...
type GroupMember struct {
	...
	Muted         bool                   `protobuf:"varint,6,opt,name=muted,proto3" json:"muted,omitempty"` // 是否被禁言
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetGroupDNDResp) GetDnd() bool {
	if x != nil {
		return x.Dnd
	}
	return false
...
const file_proto_group_proto_rawDesc = "" +
	"\n" +
	"\x11proto/group.proto\x12\bprotocol\"\xec\x01\n" +
	"\x05Group\x12\x19\n" +
	...
	"\x06remark\x18\b \x01(\tR\x06remark\"\x9e\x01\n" +
	...
	"\tjoin_time\x18\x05 \x01(\x03R\bjoinTime\x12\x14\n" +
	"\x05muted\x18\x06 \x01(\bR\x05muted\"\xab\x02\n" +
	...
	"\x03dnd\x18\x03 \x01(\bR\x03dnd\"I\n" +
	"\x0fSetGroupDNDResp\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\x12\x10\n" +
	"\x03dnd\x18\x03 \x01(\bR\x03dnd\"\x82\x01\n" +
